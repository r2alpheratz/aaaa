...
public class YRAA009SVC {
	...
	public Map<String, ? > selectListSegPassRtTrnPr(Map<String, ?> param){
		...
		resultList = (List<Map<String, Object>>) dao.list("com.korail.yz.yr.aa.YRAA009QMDAO.selectListSegPassRtTrnPrQry", getParamSet);
		result.put("dsList", resultList);
		
		resultListForCht = (List<Map<String, Object>>) dao.list("com.korail.yz.yr.aa.YRAA009QMDAO.selectListSegPassRtTrnPrChtQry", getParamSet);
