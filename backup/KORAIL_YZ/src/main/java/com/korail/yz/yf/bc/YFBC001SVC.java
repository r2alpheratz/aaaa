 ...
 * @author 나윤채
 * @date 2014. 5. 27. 오후 5:31:49
 * Class description : 하계 요일별 실적-예측 승차인원 조회
 */

@Service("com.korail.yz.yf.bc.YFBC001SVC")
public class YFBC001SVC {
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오전 11:58:52
	 * Method description : 하계요일별 승차인원 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListSmDayPssr(Map<String, ?> param){
		...
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bc.YFBC001QMDAO.selectListSmDayPssr",condMap);
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오전 11:59:31
	 * Method description : 하계요일별 실적인원 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListSmDayRst(Map<String, ?> param){
		...
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bc.YFBC001QMDAO.selectListSmDayRst",condMap);
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오전 11:59:45
	 * Method description : 하계 요일별 실적 차트 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListSmDayChart1(Map<String, ?> param){
		
		Map<String, Object> result = new HashMap<String, Object>();	
		Map<String, String> condMap = XframeControllerUtils.getParamDataSet(param, "dsCond");
		
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bc.YFBC001QMDAO.selectListSmDayChart1",condMap);
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오후 12:00:29
	 * Method description : 하계 요일별 예측 차트 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListSmDayChart2(Map<String, ?> param){
		
		Map<String, Object> result = new HashMap<String, Object>();	
		Map<String, String> condMap = XframeControllerUtils.getParamDataSet(param, "dsCond");
		
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bc.YFBC001QMDAO.selectListSmDayChart2",condMap);
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오후 12:30:08
	 * Method description : 하계 요일별 실적/예측 차트 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListSmDayChart3(Map<String, ?> param){
		
		Map<String, Object> result = new HashMap<String, Object>();	
		Map<String, String> condMap = XframeControllerUtils.getParamDataSet(param, "dsCond");
		
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bc.YFBC001QMDAO.selectListSmDayChart3",condMap);
