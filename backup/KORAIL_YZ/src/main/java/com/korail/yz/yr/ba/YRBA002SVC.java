 ...
 * Class description : 운행기간별 구간별 실적 
 */
@Service("com.korail.yz.yr.ba.YRBA002SVC")
public class YRBA002SVC {
	 ...
	 * @author "Changki.woo"
	 * @date 2014. 6. 25. 오후 1:17:30
	 * Method description : 운행기간별 구간별 실적
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ? > selectListRunTrmSegPr(Map<String, ?> param){
		...
		String svcUrl = "com.korail.yz.yr.ba.YRBA002QMDAO.selectListRunTrmSegPrQry";
