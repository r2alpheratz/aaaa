 ...
 * @author 나윤채
 * @date 2014. 7. 29. 오전 11:29:19
 * Class description : OD별 할당결과 상세정보조회
 */

@Service("com.korail.yz.yp.ab.YPAB005SVC")
public class YPAB005SVC {
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오후 4:47:25
	 * Method description : OD별 할당결과 상세정보조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListODAlcDtlInfo(Map<String, ?> param){
		...
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yp.ab.YPAB005QMDAO.selectListODAlcDtlInfo",condMap);			
		
		result.put("dsListODAlcDtlInfo", resultList);
