 ...
 * @author 나윤채
 * @date 2014. 7. 25. 오후 4:06:19
 * Class description : OD별 할당결과 운행일자별 조회
 */

@Service("com.korail.yz.yp.ab.YPAB002SVC")
public class YPAB002SVC {
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오후 4:37:05
	 * Method description : OD별 할당결과 운행일자별 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListODAlcRun(Map<String, ?> param){
		...
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yp.ab.YPAB002QMDAO.selectListODAlcRun",condMap);			
		
		result.put("dsGrdList1", resultList);
