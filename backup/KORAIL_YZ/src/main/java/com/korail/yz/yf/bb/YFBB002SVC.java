 ...
 * @author 나윤채
 * @date 2014. 5. 16. 오후 2:52:41
 * Class description : 공휴일 시간대별 실적-예측 승차인원 조회
 */

@Service("com.korail.yz.yf.bb.YFBB002SVC")
public class YFBB002SVC {
	...
	public Map<String, ?> selectListHoliTime(Map<String, ?> param){
		...
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bb.YFBB002QMDAO.selectListHoliTime",condMap);
	...
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListHoliIdx(Map<String, ?> param){
		
		Map<String, Object> result = new HashMap<String, Object>();
		Map<String, String> condMap = XframeControllerUtils.getParamDataSet(param, "dsCond");	
		
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bb.YFBB002QMDAO.selectListHoliIdx",condMap);
	...
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectHoliTmDayChart(Map<String, ?> param){
		
		Map<String, Object> result = new HashMap<String, Object>();
		Map<String, String> condMap = XframeControllerUtils.getParamDataSet(param, "dsCond");	
		
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bb.YFBB002QMDAO.selectHoliTmDayChart",condMap);
		
		result.put("dsChart1", resultList);
