...
public class YRAA006SVC {
	...
	public Map<String, ? > selectListDatePrRunAcvm(Map<String, ?> param){
		...
		resultList = (List<Map<String, Object>>) dao.list("com.korail.yz.yr.aa.YRAA006QMDAO.selectListDatePrRunAcvmQry", getParamSet);
	...
	public Map<String, ? > selectListDatePrRunSegPrAcvm(Map<String, ?> param){
		...
		resultList = (List<Map<String, Object>>) dao.list("com.korail.yz.yr.aa.YRAA006QMDAO.selectListDatePrRunSegPrAcvmQry", getParamSet);
		if(resultList.size() < 1){
