...
/**
 * @author "Changki.woo"
 * @date 2014. 5. 27. 오후 3:44:14
 * Class description : 예매일별 할당결과 조회 - YRAC004_S01 
 */
@Service("com.korail.yz.yr.ac.YRAC004SVC")
public class YRAC004SVC {
	 ...
	 * Method description : 예매일별 할당결과 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Map<String, ? > selectListResvDtPrAlcRst(Map<String, ?> param) throws Exception{
		...
		String url = "com.korail.yz.yr.ac.YRAC004QMDAO.selectListBokgPrAlcCnqe";
	 ...
	 */
	/*@SuppressWarnings({ "unchecked", "rawtypes" })
	public Map<String, ? > selectListResvDtPrAlcRst(Map<String, ?> param){
		...
		String urlBaseAlc = "com.korail.yz.yr.ac.YRAC004QMDAO.selectListResvDtPrAlcRstBaseQry"; //부킹클래스 F1의 정보들. TB_YYDK328
		String urlExtAlc  = "com.korail.yz.yr.ac.YRAC004QMDAO.selectListResvDtPrAlcRstExtQry" ;//부킹클래스 F1이외의 정보들. TB_YYDD513\
		...
		for(int i =0; i< resultBaseList.size(); i++)
		{
			...
			nRow.setDealDt(bsListRow.get("DEAL_DT").toString());
		...
		for(int j =0; j< resultExtList.size(); j++)
		{
			...
			//ArrayList<Integer> firstAlcNumContArr = yzComm.fn_yzcomm_str64_to_int( extListRow.get("FIRST_ALC_NUM_CONT").toString() ); // 최초할당수
