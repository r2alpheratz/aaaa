 ...
 * @author 나윤채
 * @date 2014. 6. 9. 오후 3:32:49
 * Class description : 연말연시 DSP별 예약-취소 예측인원 조회
 */

@Service("com.korail.yz.yf.bd.YFBD003SVC")
public class YFBD003SVC {
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오후 12:50:10
	 * Method description : 연말연시 DSP별 예약-취소 예측 승차인원 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListEyDspPssr(Map<String, ?> param){
		...
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bd.YFBD003QMDAO.selectListEyDspPssr",condMap);
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오후 12:48:40
	 * Method description : 연말연시 DSP별 예약-취소 실적인원 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListEyDspRst(Map<String, ?> param){
		
		Map<String, Object> result = new HashMap<String, Object>();
		Map<String, String> condMap = XframeControllerUtils.getParamDataSet(param, "dsPssrCond1");
	
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String, Object>>) dao.list("com.korail.yz.yf.bd.YFBD003QMDAO.selectListEyDspRst", condMap);
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오후 12:49:09
	 * Method description : 연말연시 DSP별 예약-취소 실적 차트 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListEyDspRctChart(Map<String, ?> param){
		
		Map<String, Object> result = new HashMap<String, Object>();
		Map<String, String> condMap = XframeControllerUtils.getParamDataSet(param, "dsDayCond");	

		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bd.YFBD003QMDAO.selectListEyRsvRctChart",condMap);
		ArrayList<Map<String, Object>> resultList2 = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bd.YFBD003QMDAO.selectListEyCncRctChart",condMap);
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오후 12:49:23
	 * Method description : 연말연시 DSP별 예약-취소 예측차트 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListEyDspChart(Map<String, ?> param){
		
		Map<String, Object> result = new HashMap<String, Object>();
		Map<String, String> condMap = XframeControllerUtils.getParamDataSet(param, "dsDayCond");

		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bd.YFBD003QMDAO.selectListEyRsvChart",condMap);
		ArrayList<Map<String, Object>> resultList2 = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bd.YFBD003QMDAO.selectListEyCncChart",condMap);
	...
	/**
	 * @author 나윤채
	 * @date 2015. 1. 31. 오후 12:49:38
	 * Method description : 연말연시 DSP별 예약-취소 누적비율 조회
	 * @param param
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public Map<String, ?> selectListEyDspRate(Map<String, ?> param){
		
		Map<String, Object> result = new HashMap<String, Object>();
		Map<String, String> condMap = XframeControllerUtils.getParamDataSet(param, "dsPssrCond1");	
		
		ArrayList<Map<String, Object>> resultList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bd.YFBD003QMDAO.selectListEyDspRate", condMap);
		ArrayList<Map<String, Object>> resultRSVList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bd.YFBD003QMDAO.selectListEyRsvRate", condMap);
		ArrayList<Map<String, Object>> resultCNCList = (ArrayList<Map<String,Object>>)dao.list("com.korail.yz.yf.bd.YFBD003QMDAO.selectListEyCncRate", condMap);
