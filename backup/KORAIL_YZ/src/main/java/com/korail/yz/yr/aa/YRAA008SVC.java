...
public class YRAA008SVC {
	...
	public Map<String, ? > selectListRestSeatAcvmByDate(Map<String, ?> param){
		...
		resultList = (List<Map<String, Object>>) dao.list("com.korail.yz.yr.aa.YRAA008QMDAO.selectListRestSeatAcvmByDateQry", getParamSet);
	...
	public Map<String, ? > selectListRestSeatAcvmByTrn(Map<String, ?> param){
		...
		String trnOprBzDvCd = XframeControllerUtils.getParamData(param, "GDS_USER_INFO", "TRN_OPR_BZ_DV_CD");
		getParamSet.put("TRN_OPR_BZ_DV_CD", trnOprBzDvCd);
		resultList = (List<Map<String, Object>>) dao.list("com.korail.yz.yr.aa.YRAA008QMDAO.selectListRestSeatAcvmByTrnQry", getParamSet);
