        SELECT /*+ com.korail.yz.ys.eb.YSEB001QMDAO.selectListSpllRecpSaleVs4Wk */ 
             ...
             TO_CHAR (LPAD (TO_NUMBER (A.TRN_NO), 5, ' ')) AS TRN_NO,
             A.TRN_NO AS TRN_NO1,
             A.ABRD_PRNB AS ABRD_PRNB,
             A.AVG_OF_ABRD_PRNB AS AVG_OF_ABRD_PRNB,
             A.ABRD_PRNB_PERCENTAGE AS ABRD_PRNB_PERCENTAGE,
             A.AVG_OF_ABRD_PRNB_PERCENTAGE AS AVG_OF_ABRD_PRNB_PERCENTAGE,
        ...
        FROM (  SELECT A2.START_TM,
                  ...
                  FROM (SELECT A1.START_TM,
                               ...
                               A1.CNT,
                               A1.CLOSE_DAY,
                               NVL (LEAD (A1.D_DAY) OVER (PARTITION BY A1.START_TM, A1.TRN_NO ORDER BY A1.START_TM, A1.TRN_NO, A1.D_DAY),60)
                                  AS D_DAY_F
                          FROM (SELECT    SUBSTR (A.START_TM, 1, 2)
                                       ...
                                       DECODE (NVL (#ACVM_DV_CD#, '3'), '1', B.RESERVE_CNT, '2', B.CANCEL_CNT, '3', B.RESERVE_CNT - B.CANCEL_CNT)
                                          AS CNT,
                                       B.CLOSE_DAY
                                  FROM (SELECT A.START_TM,
                                               ...
                                               A.AVG_OF_ABRD_PRNB_PERCENTAGE,
                                               CASE
                                                  WHEN 0 > A.ABRD_PRNB - A.AVG_OF_ABRD_PRNB
                                                  THEN A.ABRD_PRNB - A.AVG_OF_ABRD_PRNB
                                                  ELSE 0
                                               END * -1
                                                  AS ESCAPE_CNT,
                                               CASE
                                          ...
                                          FROM (SELECT A.START_TM,
                                                       ...
                                                       A.SEG_GP_NO
                                                  FROM (  SELECT /*+ RULE */ B.DPT_TM AS START_TM,
                                                                 A.TRN_NO AS TRN_NO,
                                                                 B.STOP_RS_STN_CD
                                                                    AS START_STN_CD,
                                                            ...
                                                            FROM (  SELECT A.TRN_NO,
                                                                     ...
                                                                     WHERE A.RUN_DT = #RUN_DT#
                                                                       AND (#PSRM_CL_CD# IS NULL OR A.PSRM_CL_CD = #PSRM_CL_CD#)
                                                                       AND (#BKCL_CD# IS NULL OR  A.BKCL_CD LIKE DECODE (#BKCL_CD#, 'F1', 'F%', #BKCL_CD#))
                                                           ...
                                                           WHERE A.TRN_NO = B.TRN_NO
                                                             ...
                                                             AND (#STLB_TRN_CLSF_CD# IS NULL OR D.STLB_TRN_CLSF_CD = #STLB_TRN_CLSF_CD#)
                                                                                ...
                                                                                FROM (  SELECT A.DPT_TM,
                                                                                          ...
                                                                                          FROM (  SELECT A.TRN_NO,
                                                                                                                                    ...
                                                                                                                                    FROM (  SELECT A.RUN_DT
                                                                                                                                             ...
                                                                                                                                             WHERE A.RUN_DT = B.RUN_DT
                                                                                                                                               AND A.RUN_DT BETWEEN TO_CHAR (TO_DATE (#RUN_DT#, 'YYYYMMDD') - 56, 'YYYYMMDD') 
                                                                                                                                                                AND TO_CHAR (TO_DATE (#RUN_DT#, 'YYYYMMDD'), 'YYYYMMDD')
                                                                                                                                               AND A.DAY_DV_CD = (  SELECT DAY_DV_CD
                                                                                                                                                                      FROM TB_YYDK002
                                                                                                                                                                     WHERE RUN_DT = TO_CHAR (TO_DATE(#RUN_DT#, 'YYYYMMDD'), 'YYYYMMDD')
                                                                                                                                                                 )
                                                                                                   ...
                                                                                                   WHERE A.TRN_NO = B.TRN_NO
                                                                                                     ...
                                                                                                     AND A.TRN_NO = E.TRN_NO
                                                                                                     AND A.RUN_DT = E.RUN_DT
                                                                                                     AND (#STLB_TRN_CLSF_CD# IS NULL OR E.STLB_TRN_CLSF_CD = #STLB_TRN_CLSF_CD#)
