...
public class YRAA002SVC {
	...
	public Map<String, ? > selectListAppTrnDtlAcvm(Map<String, ?> param){
		...
		resultList = (ArrayList) dao.list("com.korail.yz.yr.aa.YRAA002QMDAO.selectListDtlAcvmQry", getParamSet);
	...
	public Map<String, ? > selectTrnRunInfo(Map<String, ?> param){
		...
		resultList = (ArrayList) dao.list("com.korail.yz.yr.aa.YRAA002QMDAO.selectTrnRunInfoQry", getParamSet);
	...
	public Map<String, ? > selectTrnBsInfo(Map<String, ?> param){
		...
		resultList = (ArrayList) dao.list("com.korail.yz.yr.aa.YRAA002QMDAO.selectTrnBaseInfoQry", getParamSet);
